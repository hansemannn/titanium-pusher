...
@property (nonatomic, readonly) BOOL shouldParseJSONForLegacyCallbacks;
...
/// \param event The JSON object received from the websocket
///
- (void)handleGlobalEventLegacyWithEvent:(NSDictionary<NSString *, id> * _Nonnull)event;
...
/// returns:
/// A unique callbackId that can be used to unbind the callback at a later time
- (NSString * _Nonnull)bindLegacy:(void (^ _Nonnull)(id _Nullable))callback SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A callbackId that can be used to remove the callback from the connection
- (NSString * _Nonnull)addLegacyCallbackToGlobalChannel:(void (^ _Nonnull)(id _Nullable))callback SWIFT_WARN_UNUSED_RESULT;
